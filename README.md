...
This project aims to improve the user experience when searching for lecture slides. It uses elasticsearch for a more responsive and fluid search.


To run this application it is only necessary to install Flask and a few extensions that can be found in the next section. 
Once all the installation is completed the application can be run by executing the following commands.
...
```
$ pip install -r Flask==2.1.3
$ pip install -r elasticsearch==2.1.3
